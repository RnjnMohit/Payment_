export default function Info(){
    return <>
        <div className=" flex my-32 justify-between align-middle font-sans">
            <div className="ml-10">
                <p className=" text-white font-bold text-2xl">Trusted By Over 4M Customers</p>
                <p className="text-8xl text-white font-bold">Pay Anyone,</p>
                <p className="text-8xl text-white font-bold mb-5">Anywhere</p>
                <p className=" w-2/5 text-white text-2xl">Quickly and easily send, receive and request money online with _______ Money Transfer App. Get a customised solution to fit your business needs.</p>
                <div className="flex mt-5">
                    <button className="bg-white text-blue rounded-xl p-4 px-6 my-0 ml-0 hover:text-blue-800 hover:bg-blue-100 transition duration-150 flex justify-between align-middle border border-blue-800 mr-5" >Open a free account</button>
